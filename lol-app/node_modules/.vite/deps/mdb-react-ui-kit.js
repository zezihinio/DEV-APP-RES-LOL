...
function getCompositeRect2(elementOrVirtualElement, offsetParent, isFixed) {
  ...
  if (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) {
    ...
    isScrollParent2(documentElement)) {
      scroll2 = getNodeScroll2(offsetParent);
    }
...
function calcOrigin(origin, offset3, size) {
  return typeof origin === "string" ? origin : px.transform(offset3 + size * origin);
}
...
var InViewFeature = class extends Feature {
  ...
  startObserver() {
    this.unmount();
    const { viewport: viewport3 = {} } = this.node.getProps();
    const { root, margin: rootMargin, amount = "some", once } = viewport3;
    const options = {
...
function hasViewportOptionChanged({ viewport: viewport3 = {} }, { viewport: prevViewport = {} } = {}) {
  return (name) => viewport3[name] !== prevViewport[name];
}
...
var dimensionValueTypes = [number, px, percent, degrees, vw, vh, auto3];
...
function applyConstraints(point, { min: min3, max: max3 }, elastic) {
  if (min3 !== void 0 && point < min3) {
    point = elastic ? mix(min3, point, elastic.min) : Math.max(point, min3);
  } else if (max3 !== void 0 && point > max3) {
    point = elastic ? mix(max3, point, elastic.max) : Math.min(point, max3);
  }
  return point;
}
...
var positionalValues = {
  ...
  bottom: ({ y: y2 }, { top: top3 }) => parseFloat(top3) + (y2.max - y2.min),
  right: ({ x }, { left: left3 }) => parseFloat(left3) + (x.max - x.min),
  // Transform
...
function PopChild({ children, isPresent }) {
  ...
  (0, import_react21.useInsertionEffect)(() => {
    const { width, height, top: top3, left: left3 } = size.current;
...
function ReorderGroup({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const context = {
    ...
    registerItem: (value, layout2) => {
      ...
      if (idx !== -1) {
        order3[idx].layout = layout2[axis];
      } else {
...
var GroupPlaybackControls = class {
  ...
  get duration() {
    let max3 = 0;
    for (let i = 0; i < this.animations.length; i++) {
      max3 = Math.max(max3, this.animations[i].duration);
    }
    return max3;
  }
  runAll(methodName) {
...
function addKeyframes(sequence, keyframes2, easing, offset3, startTime, endTime) {
...
var ke = import_react45.default.forwardRef(
  ({
    ...
    return (0, import_jsx_runtime.jsx)(g, { className: L, ref: B, ...D, children: t });
  }
);
...
var Be = import_react45.default.forwardRef(
  ({
    ...
    const p = (0, import_react45.useRef)(null), m2 = Ae(u, p), g = "rgba({{color}}, 0.2) 0, rgba({{color}}, 0.3) 40%, rgba({{color}}, 0.4) 50%, rgba({{color}}, 0.5) 60%, rgba({{color}}, 0) 70%", b = [0, 0, 0], v = ["primary", "secondary", "success", "danger", "warning", "info", "light", "dark"], [h, D] = (0, import_react45.useState)([]), [B, L] = (0, import_react45.useState)(false), M = clsx_m_default(
      "ripple",
      "ripple-surface",
      ...
      const { offsetX: T, offsetY: E, height: j, width: R } = x, O = E <= j / 2, P = T <= R / 2, H = (J, Q) => Math.sqrt(J ** 2 + Q ** 2), A = E === j / 2 && T === R / 2, G = {
        first: O === true && P === false,
        second: O === true && P === true,
        third: O === false && P === true,
        fourth: O === false && P === false
      }, X = {
        topLeft: H(T, E),
        topRight: H(R - T, E),
        bottomLeft: H(T, j - E),
      ...
      var W;
      const T = (W = m2.current) == null ? void 0 : W.getBoundingClientRect(), E = x.clientX - T.left, j = x.clientY - T.top, R = T.height, O = T.width, P = {
        offsetX: s ? R / 2 : E,
        offsetY: s ? O / 2 : j,
        height: R,
        width: O
    ...
    }, [n, h]), (0, import_jsx_runtime.jsxs)(t, { className: M, onMouseDown: (x) => _(x), ref: m2, ...d, children: [
      o,
      h.map((x, T) => (0, import_jsx_runtime.jsx)(Se, { style: x }, T))
    ] });
  }
);
...
var ce = import_react45.default.forwardRef(
  ({
    ...
    const [D, B] = (0, import_react45.useState)(u || false);
    let L;
    ...
    return i && g !== "a" && (g = "a"), ["hr", "img", "input"].includes(g) || m2 ? (0, import_jsx_runtime.jsx)(
      g,
      {
        className: I,
        onClick: p ? () => {
...
var is = ({
  ...
  const [h, D] = (0, import_react45.useState)(null), [B, L] = (0, import_react45.useState)(null), [M, I] = (0, import_react45.useState)(false), [S, $] = (0, import_react45.useState)(false), [C, _] = (0, import_react45.useState)(false), [x, T] = (0, import_react45.useState)(false), E = clsx_m_default("tooltip", C && "show", "fade", e), { styles: j, attributes: R } = usePopper(h, B, {
    placement: c,
    ...a
  });
  (0, import_react45.useEffect)(() => {
    let A, G;
    return M || S ? (T(true), A = setTimeout(() => {
      _(true);
    }, 4)) : (_(false), G = setTimeout(() => {
      T(false);
    }, 300)), () => {
...
var Ue = import_react45.default.forwardRef(
  ({
    ...
    return (0, import_jsx_runtime.jsx)(u, { className: b, ...m2, ref: g, children: r });
  }
);
...
var Je = import_react45.default.forwardRef(
  ({
    ...
    return a && (s = "blockquote"), (i || d) && (s = "ul"), (0, import_jsx_runtime.jsx)(s, { className: m2, ref: p, ...u, children: t });
  }
);
...
var et = import_react45.default.forwardRef(
  ({
    ...
    const [v, h] = (0, import_react45.useState)(false), D = clsx_m_default(
      {
        "navbar-light": s,
        "navbar-dark": n,
      ...
      m2 && `bg-${m2}`,
      e
    ), B = (0, import_react45.useCallback)(() => {
      o && window.pageYOffset > o ? h(true) : h(false);
    }, [o]);
    return (0, import_react45.useEffect)(() => ((r || o) && window.addEventListener("scroll", B), () => {
      window.removeEventListener("scroll", B);
    }), [B, r, o]), (0, import_jsx_runtime.jsx)(p, { className: D, role: "navigation", ...g, ref: b, children: t });
  }
);
...
var us = ({
  ...
  const g = clsx_m_default(
    ...
    p && "table-striped",
    e
  ), b = (0, import_react45.useMemo)(() => (0, import_jsx_runtime.jsx)("table", { className: g, ...m2, children: o }), [o, g, m2]);
  if (s) {
...
var ft = import_react45.default.forwardRef(
  ({
    ...
    var z;
    const [I, S] = (0, import_react45.useState)(r), $ = (0, import_react45.useMemo)(() => n !== void 0 ? n : I, [n, I]), [C, _] = (0, import_react45.useState)(0), [x, T] = (0, import_react45.useState)(false), [E, j] = (0, import_react45.useState)(0), R = (0, import_react45.useRef)(null), O = ut(R), P = (0, import_react45.useRef)(null), H = g || P;
    (0, import_react45.useImperativeHandle)(M, () => R.current);
    const A = clsx_m_default("form-outline", s && "form-white", o), G = clsx_m_default(
      "form-control",
      x && "active",
      v === "date" && "active",
      t && `form-control-${t}`,
      e
    ), X = clsx_m_default("form-label", c), W = (0, import_react45.useCallback)(() => {
      var w;
      (w = H.current) != null && w.clientWidth && _(H.current.clientWidth * 0.8 + 8);
    }, [H]), J = (w) => {
      S(w.target.value), B && j(w.target.value.length), p == null || p(w);
    }, Q = (0, import_react45.useCallback)(
      (w) => {
        R.current && (T(!!$), h && h(w));
      },
      [$, h]
    ...
    return (0, import_react45.useEffect)(() => {
      W();
    }, [(z = H.current) == null ? void 0 : z.clientWidth, W, O]), (0, import_react45.useEffect)(() => {
      if ($)
        return T(true);
      T(false);
    }, [$]), (0, import_jsx_runtime.jsxs)(d, { className: A, style: i, children: [
      (0, import_jsx_runtime.jsx)(
        "input",
        {
          type: v,
      ...
      u && (0, import_jsx_runtime.jsx)("label", { className: X, style: b, htmlFor: a, ref: H, children: u }),
      ...
      m2,
      B && L.maxLength && (0, import_jsx_runtime.jsx)("div", { className: "form-helper", children: (0, import_jsx_runtime.jsx)("div", { className: "form-counter", children: `${E}/${L.maxLength}` }) })
    ] });
  }
);
...
var ie = (0, import_react45.forwardRef)(
  ({
    ...
    const B = clsx_m_default(
      ...
      g && "form-switch",
      n
    ), L = clsx_m_default(h, e), M = clsx_m_default(D, s), I = (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    return (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: m2 ? I : (0, import_jsx_runtime.jsx)(a, { style: c, className: B, ref: v, children: I }) });
  }
);
...
var pt = ({
  ...
  const [p, m2] = (0, import_react45.useState)(false), [g, b] = (0, import_react45.useState)(void 0), [v, h] = (0, import_react45.useState)(false), D = clsx_m_default(
    v ? "collapsing" : "collapse",
    !v && p && "show",
    r && "navbar-collapse",
    e
  ), B = (0, import_react45.useRef)(null), L = c ?? B, M = (0, import_react45.useRef)(null), I = (0, import_react45.useCallback)(() => {
    p && b(void 0);
  }, [p]);
  return (0, import_react45.useEffect)(() => (window.addEventListener("resize", I), () => {
    window.removeEventListener("resize", I);
  }), [I]), mt({ showCollapse: p, setCollapseHeight: b, refCollapse: L, contentRef: M }), (0, import_react45.useEffect)(() => {
    p !== s && (s ? i == null || i() : d == null || d(), m2(s)), p && h(true);
    const S = setTimeout(() => {
      h(false);
    }, 350);
    return () => {
  ...
  }, [s, p, i, d]), (0, import_jsx_runtime.jsx)(a, { style: { height: g, ...o }, id: n, className: D, ...u, ref: L, children: (0, import_jsx_runtime.jsx)("div", { ref: M, className: "collapse-content", children: t }) });
};
...
var gt = ({
  ...
  const [d, u] = (0, import_react45.useState)(t), [p, m2] = (0, import_react45.useState)(null), [g, b] = (0, import_react45.useState)(null), [v, h] = (0, import_react45.useState)(-1);
  return (0, import_jsx_runtime.jsx)(
    Te.Provider,
    {
      value: {
...
var bs = ({
  ...
  const { setIsOpenState: m2, onClose: g, setActiveIndex: b } = re();
  return (0, import_jsx_runtime.jsx)(t, { style: r, onClick: (h) => {
    g == null || g(h), e == null || e(h), !(i || u || h.defaultPrevented) && (setTimeout(() => b(-1), 300), m2(false));
...
var vs = ({
  ...
  if (!L && !o)
    return null;
  const _ = (0, import_jsx_runtime.jsx)(
    t,
    {
      className: C,
      ...
      children: import_react45.Children.map(
        s,
        (x, T) => (0, import_react45.cloneElement)(x, {
          tabIndex: 0,
          "data-active": d === T && true,
          className: clsx_m_default(d === T ? "active" : "", x.props.className)
        })
      )
    }
  );
  return (0, import_jsx_runtime.jsx)(le, { disablePortal: !c, children: _ });
};
var ys = ({
  className: e,
  tag: t = ce,
  ...
  const { setIsOpenState: c, setReferenceElement: o, isOpenState: i, setActiveIndex: d, onClose: u, onOpen: p } = re(), m2 = clsx_m_default("dropdown-toggle", r && "dropdown-toggle-split", e);
  return (0, import_jsx_runtime.jsx)(
    t,
    {
      onClick: (b) => {
...
var Ns = ({
  ...
  const [h, D] = (0, import_react45.useState)(), [B, L] = (0, import_react45.useState)(), { styles: M, attributes: I } = usePopper(h, B, { placement: d, ...p }), [S, $] = (0, import_react45.useState)(i ?? false), C = De(S, i), [_, x] = (0, import_react45.useState)(false), [T, E] = (0, import_react45.useState)(false), j = clsx_m_default("popover fade", _ && C && "show", e), R = (P) => {
    C && !u ? c == null || c() : C || a == null || a(), u ? (E(true), $(true)) : $(!C), g && g(P);
  }, O = (0, import_react45.useCallback)(
    (P) => {
      T && B && C && h && !h.contains(P.target) && ($(false), c == null || c());
    },
    [T, C, B, h, c]
  );
  return (0, import_react45.useEffect)(() => {
  ...
  }, [C]), (0, import_react45.useEffect)(() => (C && document.addEventListener("mousedown", O), () => {
    document.removeEventListener("mousedown", O);
  }), [O, C]), (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    (0, import_jsx_runtime.jsx)(r, { onClick: R, className: t, ...v, ref: D, children: s }),
    (_ || C) && (0, import_jsx_runtime.jsx)(le, { disablePortal: b, children: (0, import_jsx_runtime.jsx)(
      o,
      {
        className: j,
        ref: L,
...
var Ms = ({
  ...
  const [B, L] = (0, import_react45.useState)(m2), M = De(B, p), [I, S] = (0, import_react45.useState)(false), [$, C] = (0, import_react45.useState)([]), _ = (0, import_react45.useMemo)(() => motion(v), [v]), x = (0, import_react45.useRef)(null), T = o || x, E = {
    opacity: 0,
    ...Mt(e),
    ...h.initial ? h.initial : {}
  }, j = {
    ...
    r
  ), P = clsx_m_default("modal-backdrop", "fade", M && "show"), H = (0, import_react45.useCallback)(() => {
    L(false), i == null || i();
  }, [i]), A = (0, import_react45.useCallback)(() => {
    S(true), d == null || d(), setTimeout(() => {
      S(false);
    }, 300);
  }, [d]), G = (0, import_react45.useCallback)(
    (W) => {
  ...
  return (0, import_react45.useEffect)(() => {
    ...
    C(() => Dt(T));
  }, [T, M, n]), (0, import_react45.useEffect)(() => {
    const W = () => {
    ...
    const W = (J) => {
      J.target.closest(".modal-dialog") || window.addEventListener("mouseup", G, { once: true });
    };
  ...
  }, [X, G]), (0, import_jsx_runtime.jsx)(le, { disablePortal: !t, children: (0, import_jsx_runtime.jsxs)(AnimatePresence, { children: [
...
var fe = import_react45.default.createContext({
  activeElement: null,
  setTargets: null
});
var Ds = ({
  ...
  const a = clsx_m_default("sticky-top", t), [c, o] = (0, import_react45.useState)(null), [i, d] = (0, import_react45.useState)([]), u = e instanceof Window, p = (0, import_react45.useCallback)(() => {
    ...
    if (!i.length)
      return;
    const m2 = u ? window.pageYOffset : (D = e == null ? void 0 : e.current) == null ? void 0 : D.scrollTop, g = Number(n), b = (B = i[i.length - 1]) == null ? void 0 : B.current, v = (L = i[0]) == null ? void 0 : L.current;
    m2 + g < v.offsetTop && o(null), i.forEach((M, I) => {
      var _;
      const S = (_ = i[I + 1]) == null ? void 0 : _.current, $ = M.current;
      if (m2 > $.offsetTop - g && m2 < (S == null ? void 0 : S.offsetTop) - g) {
        o($);
        return;
      }
    }), m2 > b.offsetTop - g && o(b);
  }, [n, i, u, e]);
  return (0, import_react45.useEffect)(() => {
    const m2 = u ? e : e == null ? void 0 : e.current;
    return p(), m2 == null || m2.addEventListener("scroll", p), () => {
      m2 == null || m2.removeEventListener("scroll", p);
    };
  }, [p, e, u]), (0, import_jsx_runtime.jsx)("div", { className: a, ...r, children: (0, import_jsx_runtime.jsx)("ul", { className: "nav flex-column nav-pills menu-sidebar", children: (0, import_jsx_runtime.jsx)(fe.Provider, { value: { activeElement: c, setTargets: d }, children: s }) }) });
};
var Ts = ({
  className: e,
  collapsible: t,
  ...
  var v;
  const { activeElement: i, setTargets: d } = (0, import_react45.useContext)(fe), u = () => r == null ? void 0 : r.some((h) => h.current.id === (i == null ? void 0 : i.id)), p = (i == null ? void 0 : i.id) === ((v = s.current) == null ? void 0 : v.id), m2 = p || u();
  p && (c == null || c(i == null ? void 0 : i.id));
  const g = clsx_m_default("nav-link", t && "collapsible-scrollspy", m2 && "active", e), b = (h) => {
...
var $s = ({
  ...
  const [a, c] = (0, import_react45.useState)("0px"), { activeElement: o } = (0, import_react45.useContext)(fe), i = clsx_m_default("nav flex-column", t), d = (0, import_react45.useRef)(null);
  (0, import_react45.useEffect)(() => {
    const p = () => e == null ? void 0 : e.some((g) => g.current.id === (o == null ? void 0 : o.id)), m2 = d.current;
    p() ? c(`${m2 == null ? void 0 : m2.scrollHeight}px`) : c("0px");
  }, [o, e]);
  const u = {
    overflow: "hidden",
    height: a,
...
var Rs = ({
  ...
  const [D, B] = (0, import_react45.useState)(t), [L, M] = (0, import_react45.useState)(false), I = clsx_m_default("form-range", e), S = clsx_m_default("form-label", p);
  return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    (0, import_jsx_runtime.jsxs)("div", { className: "range", children: [
      ...
      !s && (0, import_jsx_runtime.jsx)(Ct, { value: m2 || D, showThumb: L, min: a, max: r })
    ] })
  ] });
};
...
var me = (0, import_react45.createContext)({
  active: 0
});
var Yt = ({ imagesCount: e, to: t }) => {
  const { active: s } = (0, import_react45.useContext)(me);
...
var Is = ({
  ...
  const m2 = (0, import_react45.useRef)([]), g = (0, import_react45.useRef)(null), b = (0, import_react45.useRef)(0), v = (0, import_react45.useRef)(false), [h, D] = (0, import_react45.useState)(0), [B, L] = (0, import_react45.useState)(0), [M, I] = (0, import_react45.useState)({ initialX: 0, initialY: 0 }), [S, $] = (0, import_react45.useState)(false), C = (0, import_react45.useRef)(null), _ = clsx_m_default("carousel", "slide", e && "carousel-fade", n && "carousel-dark", t), x = clsx_m_default("carousel-inner", s), T = (0, import_react45.useCallback)(
    (w, F) => {
      if (F !== void 0)
        b.current = F, D(F);
      else {
    ...
    [h, B]
  ), E = (0, import_react45.useCallback)(() => {
    g.current && (clearInterval(g.current), g.current = null);
  }, []), j = (0, import_react45.useCallback)(
    (w, F, K) => {
      var pe;
      if (!m2.current || m2.current.length < 2)
        return;
      $(true);
      const Z = m2.current[h], te = Boolean(g.current), ae = w === "next", oe = ae ? "carousel-item-start" : "carousel-item-end", de = ae ? "carousel-item-next" : "carousel-item-prev";
      if (F.classList.contains("active")) {
        v.current = false;
        return;
      }
      T(w, K), !(!Z || !F) && (v.current = true, te && E(), (pe = C.current) != null && pe.classList.contains("slide") ? (F.classList.add(de), Vt(F), Z.classList.add(oe), F.classList.add(oe), qt(() => {
        $(false), F.classList.remove(oe, de), F.classList.add("active"), Z.classList.remove("active", de, oe), v.current = false;
      }, Z, true)) : (Z.classList.remove("active"), F.classList.add("active"), v.current = false));
    },
    [C, h, T, E]
  ), R = (w) => {
    ...
    (w) => {
      const F = w === "prev", Z = (b.current + (F ? -1 : 1)) % B, te = m2.current;
      return Z === -1 ? te[B - 1] : te[Z];
    },
    [B]
  ), P = (w) => {
    const F = b.current, K = w > F ? "next" : "prev", ee = m2.current;
  ...
  return (0, import_react45.useEffect)(() => {
    ...
    "div",
    {
      ...
      ref: C,
      ...p,
      children: (0, import_jsx_runtime.jsx)("div", { className: x, children: (0, import_jsx_runtime.jsxs)(me.Provider, { value: { active: h }, children: [
        d && (0, import_jsx_runtime.jsx)(Yt, { to: H, imagesCount: B }),
        r,
...
var xs = ({ className: e, children: t, itemId: s, ...n }) => {
  const { active: r } = (0, import_react45.useContext)(me), a = (0, import_react45.useRef)(true), c = (0, import_react45.useRef)(null), o = clsx_m_default("carousel-item", e);
  return (0, import_react45.useEffect)(() => {
    if (a.current && r === s - 1) {
      const i = c.current;
...
var Qt = import_react45.default.forwardRef(
  ({
    ...
    const p = (0, import_react45.useMemo)(() => typeof r < "u", [r]), m2 = clsx_m_default("accordion", n && "accordion-flush", t && "accordion-borderless", s), [g, b] = (0, import_react45.useState)(a);
    return (0, import_jsx_runtime.jsx)(c, { className: m2, ref: u, ...d, children: (0, import_jsx_runtime.jsx)(
      $e.Provider,
      {
...
var Zt = import_react45.default.forwardRef(
  ({
    ...
    const { activeItem: m2, setActiveItem: g, alwaysOpen: b, onChange: v } = (0, import_react45.useContext)($e), h = (0, import_react45.useMemo)(() => Array.isArray(m2) ? m2.includes(r) : m2 === r, [m2, r]), D = clsx_m_default("accordion-item", e), B = clsx_m_default("accordion-header", n), L = clsx_m_default("accordion-body", t), M = clsx_m_default("accordion-button", !h && "collapsed", o), I = (0, import_react45.useCallback)(
      (S) => {
        let $ = S;
        Array.isArray(m2) ? m2.includes(S) ? $ = m2.filter((_) => _ !== S) : $ = b ? [...m2, S] : [S] : ($ = m2 === S ? 0 : S, b && ($ = [$])), v == null || v($), g($);
      },
      [v, m2, g, b]
    );
    return (0, import_jsx_runtime.jsxs)(i, { className: D, ref: p, ...u, children: [
      (0, import_jsx_runtime.jsx)("h2", { className: B, style: c, children: (0, import_jsx_runtime.jsx)("button", { onClick: () => I(r), className: M, type: "button", children: a }) }),
...
var ks = ({
  ...
  var G;
  const L = (0, import_react45.useRef)(null), M = (0, import_react45.useRef)(null), I = g || L, S = v || M, [$, C] = (0, import_react45.useState)(n || r), [_, x] = (0, import_react45.useState)(0), [T, E] = (0, import_react45.useState)(
    n !== void 0 && n.length > 0 || r !== void 0 && r.length > 0
  ), j = clsx_m_default("form-outline", s && "form-white", o), R = clsx_m_default("form-control", T && "active", t && `form-control-${t}`, e), O = clsx_m_default("form-label", c);
  (0, import_react45.useEffect)(() => {
    var X;
  ...
  (0, import_react45.useEffect)(() => {
    n !== void 0 && (n.length > 0 ? E(true) : E(false));
  }, [n]), (0, import_react45.useEffect)(() => {
    r !== void 0 && (r.length > 0 ? E(true) : E(false));
  }, [r]);
  const H = (X) => {
    C(X.currentTarget.value), p && p(X);
  }, A = (0, import_react45.useCallback)(
    (X) => {
      $ !== void 0 && $.length > 0 || n !== void 0 && n.length > 0 ? E(true) : E(false), h && h(X);
    },
    [$, n, h]
  );
  return (0, import_jsx_runtime.jsxs)(d, { className: j, style: { ...i }, children: [
    (0, import_jsx_runtime.jsx)(
      "textarea",
      {
        readOnly: D,
    ...
    u && (0, import_jsx_runtime.jsx)("label", { className: O, style: b, htmlFor: a, ref: I, children: u }),
    (0, import_jsx_runtime.jsxs)("div", { className: "form-notch", children: [
      (0, import_jsx_runtime.jsx)("div", { className: "form-notch-leading" }),
      (0, import_jsx_runtime.jsx)("div", { className: "form-notch-middle", style: { width: _ } }),
      (0, import_jsx_runtime.jsx)("div", { className: "form-notch-trailing" })
    ] }),
    m2
  ] });
...
var Cs = ({
  ...
  return (0, import_react45.useEffect)(() => {
    var p, m2;
    const u = (m2 = (p = i.current) == null ? void 0 : p.querySelector("input, textarea")) == null ? void 0 : m2.parentElement;
    u && o(u);
